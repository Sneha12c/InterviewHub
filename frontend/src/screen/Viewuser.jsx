...
const Viewuser = () => {
  ...
  useEffect(() => {
    const fetchSubmissions = async () => {
      try {
        ...
        const response = await axios.get(`/submit/view/${userId}?page=${currentPage}&limit=${itemsPerPage}`, {
            headers: {
  ...
  return (
    <div className="min-h-screen bg-gray-100 p-4">
      <h1 className="text-3xl font-bold text-center mb-6">User Submissions</h1>
